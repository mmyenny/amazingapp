...
class StudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create studio" do
    assert_difference('Studio.count') do
      post studios_url, params: { studio: { address: @studio.address, name: @studio.name } }, as: :json
    end
  ...
  test "should update studio" do
    patch studio_url(@studio), params: { studio: { address: @studio.address, name: @studio.name } }, as: :json
    assert_response 200
  end
